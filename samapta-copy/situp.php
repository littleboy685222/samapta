...
<head>
    ...
    <script>
        ...
        function hitungNilai(jumlah_situp) {
            if (jumlah_situp >= 41) {
                return 100;
             } else if (jumlah_situp == 40) {
                return 98;
            } else if (jumlah_situp == 39) {
                return 96;
            } else if (jumlah_situp == 38) {
                return 93;
            } else if (jumlah_situp == 37) {
                return 91;
            } else if (jumlah_situp == 36) {
                return 89;
            } else if (jumlah_situp == 35) {
                return 86;
            } else if (jumlah_situp == 34) {
                return 84;
            } else if (jumlah_situp == 33) {
                return 82;
            } else if (jumlah_situp == 32) {
                return 80;
            } else if (jumlah_situp == 31) {
                return 78;
            } else if (jumlah_situp == 30) {
                return 76;
            } else if (jumlah_situp == 29) {
                return 74;
            } else if (jumlah_situp == 28) {
                return 72;
            } else if (jumlah_situp == 27) {
                return 70;
            } else if (jumlah_situp == 26) {
                return 67;
            } else if (jumlah_situp == 25) {
                return 65;
            } else if (jumlah_situp == 24) {
                return 62;
            } else if (jumlah_situp == 23) {
                return 60;
            } else if (jumlah_situp == 22) {
                return 57;
            } else if (jumlah_situp == 21) {
                return 55;
            } else if (jumlah_situp == 20) {
                return 52;
            } else if (jumlah_situp == 19) {
                return 50;
            } else if (jumlah_situp == 18) {
                return 48;
            ...
            $(document).ready(function() {
                updateSitupCount(); // Update pertama kali saat halaman dimuat
            });
    </script>
</head>
<body>
