...
const char* ssid = "UNHAN-MAHASISWA";  // WiFi SSID
const char* password = "terusmaju";             // WiFi password
const char* serverName = "http://10.3.163.229/samapta-copy/insert_shuttlerun.php";  // Server PHP endpoint for inserting pull-up count
